...
<meta charset="UTF-8">
<link rel="stylesheet" href="/assets/admin/layout/styles/layout.css" type="text/css">
<script src="/assets/admin/layout/scripts/jquery.min.js"></script>
<script src="/assets/admin/layout/scripts/jquery-defaultvalue.js"></script>
<!-- homepage slider scripts -->
<link rel="stylesheet" href="/assets/admin/layout/scripts/supersized/supersized.css" type="text/css">
<link rel="stylesheet" href="/assets/admin/layout/scripts/supersized/supersized.shutter.css" type="text/css">
<script src="/assets/admin/layout/scripts/supersized/supersized.3.2.7.js"></script>
<script src="/assets/admin/layout/scripts/supersized/supersized.shutter.min.js"></script>
<script src="/assets/admin/layout/scripts/supersized/supersized.setup.js"></script>
<!-- / homepage slider scripts -->
</head>
<body>
  ...
  <header id="header" class="clear">
    ...
    <form action="#" method="post">
      <fieldset>
        ...
        <input type="image" src="/assets/admin/layout/images/search.gif" id="search" alt="Search">
      </fieldset>
    </form>
    <nav>
      <ul class="clear">
